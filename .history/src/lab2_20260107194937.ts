...
let listProducts: Array<{name:string,price:number,sale:boolean,rate:Rate}> = [
    { name: "Laptop", price: 1000, sale: true, rate: Rate.Cao },
    { name: "Phone", price: 500, sale: false, rate: Rate.TrungBinh },
    { name: "Tablet", price: 300, sale: true, rate: Rate.Thap },
    { name: "Monitor", price: 200, sale: false, rate: Rate.Cao },
    { name: "Headphones", price: 150, sale: true, rate: Rate.TrungBinh }
];
